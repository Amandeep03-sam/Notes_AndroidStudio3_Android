...
import com.ms.notes.model.Note;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //Insert text type
    public long insertNote(String note,String desc,String category) {
    ...
    public Note getNote(long id) {
        ...
        Cursor cursor = db.query(Note.TABLE_NAME,
                new String[]{Note.COLUMN_ID, Note.COLUMN_TITLE, Note.COLUMN_DESCRIPTION,Note.COLUMN_CATEGORY,Note.COLUMN_TYPE, Note.COLUMN_TIMESTAMP},
                Note.COLUMN_ID + "=?",
